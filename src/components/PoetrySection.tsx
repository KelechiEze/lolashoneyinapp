      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className={`flex flex-col md:flex-row md:items-end justify-between gap-6 border-b pb-8 ${isDark ? "border-white/10" : "border-neutral-200"}`}>
          ...
          <button
            ...
            className={`inline-flex items-center space-x-2 text-xs font-bold tracking-widest uppercase py-3.5 px-6 rounded-full transition-all duration-300 shadow-md cursor-pointer outline-none group shrink-0 ${
              isDark 
                ? "bg-white hover:bg-rose-600 text-neutral-950 hover:text-white" 
                : "bg-neutral-950 hover:bg-rose-600 text-white"
            }`}
          >
          ...
          {POETRY_COLLECTIONS.map((p, idx) => (
            ...
            >
              ...
              <div className="space-y-2 text-left pt-1">
                ...
                {/* Title */}
                <h3 className={`font-serif font-bold text-xl leading-snug group-hover:text-rose-600 transition-colors ${
                ...
                {/* Description */}
                <p className={`font-sans text-xs leading-relaxed line-clamp-3 ${
