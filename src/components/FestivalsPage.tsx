  ...
  const festivals: Festival[] = [
    {
      ...
      desc: "Aké is three days of cultural immersion. Each year, writers, poets, artists, filmmakers, and thinkers converge to talk, read, and debate books about Africa and Africa's relationship with the rest of the globe. Founded by Lola Shoneyin in Abeokuta in 2013, the festival moved to Lagos in 2017 and has since brought together over a thousand creatives from Africa and the diaspora. It has grown to what many now call the biggest convergence of African creatives in the world. In 2023, it won the inaugural Aficionado Award, presented by the Frankfurt and Turin book fairs, for its contribution to the quality of international publishing.",
