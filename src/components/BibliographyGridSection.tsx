...
export const BIBLIOGRAPHY_ITEMS: BibliographyItem[] = [
  ...
  },
  {
    ...
    year: "2024",
    author: "Lola Shoneyin",
    publisherOrOutlet: "Anthology",
    summary: "A vital anthology featuring eleven distinguished writers and leaders on democratic ideals, freedom, and governance.",
  ...
  },
  {
    ...
    year: "2021",
    author: "Lola Shoneyin",
    publisherOrOutlet: "The Borough Press / HarperCollins",
    summary: "An acclaimed anthology of Nigerian writers reflecting on home, identity, memory, and culture.",
